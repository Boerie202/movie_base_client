...
export class ProfileView extends React.Component {
    ...
    getUser(token) {
        ...
        axios.get(`https://movie-base-og.herokuapp.com/users/${Username}`, {
    ...
    editUser = (e) => {
        ...
        axios.put(`https://movie-base-og.herokuapp.com/users/${Username}`,
            {
    ...
    onRemoveFavorite = (e, movies) => {
        ...
        axios.delete(`https://movie-base-og.herokuapp.com/users/${Username}/movies/${movie._id}`,
            {
                headers: { Authorization: `Bearer ${token}` }
            }
        )
    ...
    onDeleteUser() {
        ...
        axios.delete(`https://movie-base-og.herokuapp.com/users/${Username}`, {
            headers: { Authorization: `Bearer ${token}` }
        })
            .then((response) => {
                console.log(response);
                        ...
                        <Card>
                            <Card.Body>
                                {FavoriteMovies.length === 0 && (
                                    <div className="text-center">My favorite movies</div>
                                )}
